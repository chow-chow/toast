...
export const errorIcon = svg`
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="#f24f70">
...
export const infoIcon = svg`
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="#3992ff">
...
export const successIcon = svg`
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="#6bd968">
...
export const warningIcon = svg`
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="#fecc1b">
